...
KNOWN_KEYS='["org_unit_types","org_units","permissions","roles","role_permissions","notification_templates","asset_directories","saml_idps","saml_sps","saml_idp_attributes","saml_attr_role_maps","users","user_role_assignments"]'
